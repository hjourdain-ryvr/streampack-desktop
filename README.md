...
```bat
iscc streampack-1.2.1.iss
```

Output: `installer\StreamPack-1.2.1-Setup.exe`
...
├── streampack-1.2.1.iss         ← Inno Setup installer script
├── README.md                    ← this file
...
Produces a per-user installer (`installer\StreamPack-1.2.1-Setup.exe`) that
