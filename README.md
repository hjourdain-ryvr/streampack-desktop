...
```bat
iscc streampack-3.2.2.iss
```

Output: `installer\StreamPack-3.2.2-Setup.exe`
...
├── streampack-3.2.2.iss         ← Inno Setup installer script
├── README.md                    ← this file
...
Produces a per-user installer (`installer\StreamPack-3.2.2-Setup.exe`) that
