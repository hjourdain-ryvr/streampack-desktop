...
class _JobCardState extends State<JobCard> {
  ...
  Widget build(BuildContext context) {
    ...
    // Only show dismiss button for terminal states
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                if (job.status == JobStatus.running && job.currentPass.isNotEmpty)
                  _Badge(
                    '${job.currentPass.toUpperCase()} pass',
            ...
            // ── Skipped renditions (upscale prevention) ───────────────────
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Skipped (would upscale): ${job.skippedRenditions}',
      ...
      children: [
        ...
        Positioned(
          ...
          child: Tooltip(
            message: 'Remove',
            child: InkWell(
              onTap: () => widget.runner.remove(job),
              borderRadius: BorderRadius.circular(999),
              child: const Padding(
                padding: EdgeInsets.all(4),
                child: Icon(Icons.close,
                    size: 13, color: Color(0xFF4a5168)),
              ),
            ),
          ),
        ),
...
class _Badge extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    padding: const EdgeInsets.symmetric(horizontal: 7, vertical: 2),
    decoration: BoxDecoration(
      color: color ?? const Color(0xFF181c22),
      border: Border.all(color: borderColor ?? const Color(0xFF2e3440)),
      borderRadius: BorderRadius.circular(4),
    ),
    child: Text(label,
        style: TextStyle(
            color: textColor ?? const Color(0xFF4a5168),
...
class _StatusPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final (label, color) = switch (status) {
      JobStatus.queued     => ('queued',     const Color(0xFF4a5168)),
      JobStatus.running    => ('running',    const Color(0xFF00d4aa)),
      JobStatus.validating => ('validating', const Color(0xFFf5c542)),
      JobStatus.done       => ('done',       const Color(0xFF00d4aa)),
      JobStatus.error      => ('error',      const Color(0xFFff4f6a)),
      JobStatus.cancelled  => ('cancelled',  const Color(0xFFf5c542)),
    };
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 7, vertical: 2),
      decoration: BoxDecoration(
